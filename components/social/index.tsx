...
export default function Social() {
  return (
    <div className={styles.container}>
      ...
      <a
        className={styles.iconLink}
        href="https://github.com/OustanDing"
        target="_blank"
        rel="noreferrer"
      >
        <svg
      ...
      >
        <svg
          ...
          viewBox="0 0 50 50"
        >
          <path d="M 13.9375 7 L 3.851563 25.003906 L 14.199219 43 L 36.0625 43 L 46.144531 25 L 36.0625 7 Z M 18 15 L 25.15625 15 C 30.597656 15 35 19.472656 35 25 C 35 30.527344 30.597656 35 25.15625 35 L 18 35 Z M 22 19 L 22 31 L 25 31 C 28.308594 31 31 28.308594 31 25 C 31 21.691406 28.308594 19 25 19 Z"></path>
        </svg>
      </a>
      <a
        className={styles.iconLink}
        href="https://www.youtube.com/channel/UCJj5pS_8w2RsOKGgzJDYmUA"
        target="_blank"
        rel="noreferrer"
      >
        <svg
